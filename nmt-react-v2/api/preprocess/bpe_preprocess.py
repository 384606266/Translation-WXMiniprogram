...
def pre(line,id):
    if id==100:
        codes = codecs.open('./preprocess/codes.50000.bpe.ron', encoding='utf-8')
        vocab = codecs.open('./preprocess/vocab.50000.bpe.ron', encoding='utf-8')
    elif id==101:
